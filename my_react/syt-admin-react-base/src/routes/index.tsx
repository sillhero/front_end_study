...
const HospitalSet = lazy(() => {return import('@/pages/hospital/hospitalSet')})
const HospitalList = lazy(() => {return import('@/pages/hospital/hospitalList/hospitalList')})
const AddOrUpdateHospitalSet = lazy(() =>  import('@/pages/hospital/hospitalSet/AddOrUpdateHospitalSet'))
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                children: [
                    {
                        path:'/syt/hospital/hostpitalSet',
                        meta: {
                            title: '医院设置'
                        },
                    ...
                    {
                        path:'/syt/hospital/hostpitalSet/add',
                        meta: {
                            title: '新增医院设置'
                        },
                    ...
                    {
                        path:'/syt/hospital/hostpitalList',
                        meta: {
                            title: '医院列表'
                        },
